...
namespace Neuron
{
	...
	public class NeuronActor
	{
		...
		public static Dictionary<NeuronBones, Queue<Vector3>> positionDelay = new Dictionary<NeuronBones, Queue<Vector3>>();
		public static Dictionary<NeuronBones, Queue<Vector3>> rotationDelay = new Dictionary<NeuronBones, Queue<Vector3>>();
		public static int FRAME_DELAY = 60;
